...
<?php include 'side-menu.php'; ?>
    ...
    <section class="vertical-padding form-container vertical-padding white-bg page-wrapper">
        <div class="container">
          <div class="row">
            <div class="col-md-12 ">
              <div class="post-form-wrapper vertical-padding">
                <form class="post-form">
                  <div class="input-group">
                    <span class="input-group-addon" id="basic-addon1"><i class="ion-compose"></i> Video Title</span>
                    <input type="text" class="form-control" placeholder="Post Title" aria-describedby="basic-addon1">
                  </div>
                   <div class="input-group">
                    <span class="input-group-addon" id="basic-addon1"><i class="ion-compose"></i>Video Embeded Code</span>
                    <textarea rows="5" name="post-content"  class="form-control" ></textarea>
                  </div>
                  <div class="input-group width-100">
                    <textarea rows="5" name="post-content"  class="form-control tinymce" ></textarea>
                  </div>
                  <!-- Split button -->
                    ...
                    <div class="input-group text-right width-100">
