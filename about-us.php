           ...
           <div class="container">
                <div class="col-md-12 vertical-padding">
                    <div class="section-title-container">
                        <h4 class="center-section-title header-font">About Us</h4>
                 ...
                 <div class="col-md-6 col-sm-6">
                    ...
                    <form id="contact-form">
                        <div class="form-wrapper vertical-padding">
                            <input type="text" name="name" placeholder="Your Name" class="width-100 ">
                        </div>
                        <div class="form-wrapper">
                            <input type="email" name="name" placeholder="Your Email" class="width-100">
                        </div>
                        <div class="form-wrapper vertical-padding">
                            <textarea rows="10" class="width-100" ></textarea>
                        </div>
                    </form>
                </div>
                <div class="col-md-6 col-sm-6">
